...
import DashboardNavbar from './BroadCasterDashboardNavbar';
import DashboardSidebar from './BroadCasterDashboardSidebar';
...
const BroadCasterDashboardLayout = () => {
...
export default BroadCasterDashboardLayout;
